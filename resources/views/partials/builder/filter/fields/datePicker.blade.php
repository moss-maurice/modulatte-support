...
<div class="px-2{{ $class }}">
    ...
    <br />
    <input type="date" name="filter[{{ $name }}]" class="form-control form-control-sm DatePicker" id="{{ $name }}" value="{{ $value }}" placeholder="{{ $placeholder }}" autocomplete="off" style="width: 100% !important;" />
